...
def loadOneRoute(filePrefix="BCN_BUD"):
    ...
    y_train = np.load('inputReg/y_train.npy')
    y_train_price = np.load('inputReg/y_train_price.npy')

    X_test = np.load('inputClf_small/X_test.npy')
    y_test = np.load('inputClf_small/y_test.npy')
    y_test_price = np.load('inputClf_small/y_test_price.npy')
